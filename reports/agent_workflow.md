...
that round (sha256 `2cd58144...a1b` as of v0.3.4; v0.3.11 was `765fd8e0...646b60`; v0.3.12 was
`1b285fe8...22456`; the current revision is `a446c216...c01085` as of
v0.3.13): no `dielectric`, `T_K` or `model_ready` value moved,
