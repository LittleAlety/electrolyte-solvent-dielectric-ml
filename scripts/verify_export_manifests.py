...
WEEK_DIRECTORIES = tuple(f"week{week}" for week in range(1, 9))
...
def select_output_dirs(
    *,
    ...
    """Select explicit directories or all eight conventional week directories."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        help="Root containing conventional week1-week8 output directories.",
    )
    parser.add_argument(
        "--allow-missing",
        action="store_true",
